 ...
 * @author mbien
 */
public class SpongebobOnGlobe extends JFrame {

    private Animator animator;

    /** Creates new form MainFrame */
    public SpongebobOnGlobe() {
        initComponents();
        setTitle("Spongebob On Globe");
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                SpongebobOnGlobe frame = new SpongebobOnGlobe();
